...
import "../../../styles/seller-withdraw.css"; // Có thể dùng chung CSS
...
export default function UserWithdrawPage() { // Đổi tên component
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      // THAY ĐỔI DUY NHẤT: Điều hướng về ví của user
      setTimeout(() => navigate("/account/wallet"), 900);
